...
if (width < 280) width = 100%;
if (height < 250) height = 100%;
if (width < height) height = width;
document.write('<iframe width='+width+' height='+height+' scrolling=no frameborder=0 scrolling=no allowtransparency=true marginwidth="0" marginheight="0" src=https://www.janjua.tv/'+embedded+'/'+channel+'/'+g+'/'+width+'/'+height+' allowfullscreen ></iframe>')
